...
JOIN ngprod.dbo.location_mstr lm ON lm.location_id = a.location_id
LEFT JOIN region r ON a.zip = r.Zip
WHERE a.appt_date >= '20180101' AND a.appt_date <= '20181231'
AND appt_kept_ind = 'y' 
...
GROUP BY lm.location_name, r.Region, r.county
HAVING COUNT (*) > 100
